"""Blackjack, by Al Sweigart al@invnetwithpython.com
The classic card game also known as 21. (this version don't have
...
def main():
    ...
    while True: # Main game loop
        ...
        # Give the dealer and player tow cards from the deck each:
        deck = getDeck()
...
def getBet(maxBet):
    ...
    while True:  # Keep asking until they enter a valid amount.
        ...
        bet = int(bet)
        if 1 <= bet <= maxBet:
            return bet  # Player enterd a valid bet    
...
def getMove(playerHand, money):
    ...
    while True:  # Keep looping until the player enters a correct move.
        ...
        # tell because they'll have exaclty tow cards:
