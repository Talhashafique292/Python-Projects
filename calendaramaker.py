...
while True:  # loop to get a year from user
...
def getCalendarFor(year, month):
    ...
    # Put the month and year at the top of calendar:
    calText += (' ' * 34) + MONTHS[month-1] + ' ' + str(year) + '\n'

    # Add the days of the week labels to the calendar:
    # (!) Try changing this abbreviations: SUN, MON, TUE etc.
    calText += '...Sunday.....Monday....Tuesday...Wednesday...Thursday....Friday....Saturday..\n'

    # The horizontal line string that separate weeks:
    weekSeparator = ('+----------' * 7) + '+\n'

    # The blank rows hav ten spaces in between the | day separator:
    blankRow = ('|          ' * 7) + '|\n'

    # Get the first date in the month. (The datetime module handles all
    # the complicated calndar stuff for us here.)
    ...
    while True:  # Loop over each week in the month.
        ...
        # dayNumberRow is the row with day number labels:
        dayNumberRow = ''
        for i in range(7):
